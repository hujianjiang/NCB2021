...
filepathALL{1} = 'Y:\GTPase4\HT1080Rac2Gin1%FBSonPAA20190821\analysis\Windowing\';
SelectedCell{1} = [3, 4, 7, 8, 9];

filepathALL{2} = 'Y:\GTPase4\HT1080Rac2Gin1%FBSonPAA20190618 - HresTF\analysis\Windowing\';
SelectedCell{2} = [1, 2, 3, 4, 5, 6, 7, 8];

LongestMovie = [1 ,8]; % point out the longest movie for initial matrix generation

filename = 'HT1080Rac2G';

savepath = 'Y:\GTPase4\Combined Results\Rac\AnalysisResults_withSmoothedProtrusion_AllDepth_v2_201216y\';
mkdir(savepath);
...
figure(2)
% imagesc(FORCEprotrusionMean,[50,280]);colormap jet;title(colorbar,'Pa');
...
figure(2)
% imagesc(FORCEprotrusionMaxVMean,[50,280]);colormap jet;title(colorbar,'Pa');
...
figure(2)
% imagesc(FRETprotrusionMean,[1000,1120]);colormap jet;colorbar;
...
figure(2)
% imagesc(FRETprotrusionMaxVMean,[1000,1120]);colormap jet;colorbar;
...
figure(2)
% imagesc(FORCEretractionMean,[50,280]);colormap jet;title(colorbar,'Pa');
...
figure(2)
% imagesc(FORCEretractionMaxVMean,[50,280]);colormap jet;title(colorbar,'Pa');
...
figure(2)
% imagesc(FRETretractionMean,[1000,1120]);colormap jet;colorbar;
...
figure(2)
% imagesc(FRETretractionMaxVMean,[1000,1120]);colormap jet;colorbar;
...
figure(2)
% imagesc(FRETprotrusionLineNormMean,[-0.2,0.1]);colormap jet;colorbar;
...
figure(2)
% imagesc(FRETretractionLineNormMean,[-0.4,0.4]);colormap jet;colorbar;
...
figure(2)
% imagesc(FRETretractionMaxVLineNormMean,[-0.2,0.2]);colormap jet;colorbar;
